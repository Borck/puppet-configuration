node default {
  ...
  if $::kernel == 'windows' {
    ...
    package { 'visualstudiocode': ensure => latest, install_options => ['--params', "'/NoDesktopIcon", "/NoQuicklaunchIcon'"],}
    ...
    package { 'winaero-tweaker': ensure => latest, } # Snappy Driver Installer Origin (open source)
    ...
    if $isMyPc {
      ...
      registry_key   { 'HKCR\HKEY_CLASSES_ROOT\*\ShellEx\ContextMenuHandlers\EPP': ensure => absent, }
      registry_key   { 'HKCR\HKEY_CLASSES_ROOT\Directory\ShellEx\ContextMenuHandlers\EPP': ensure => absent, }
      # backup:
      # registry_value { 'HKCR\HKEY_CLASSES_ROOT\*\ShellEx\ContextMenuHandlers\EPP\\': ensure => present, type => string, data => '{09A47860-11B0-4DA5-AFA5-26D86198A780}' }
      # registry_value { 'HKCR\HKEY_CLASSES_ROOT\Directory\ShellEx\ContextMenuHandlers\EPP\\': ensure => present, type => string, data => '{09A47860-11B0-4DA5-AFA5-26D86198A780}' }
